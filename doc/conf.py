...
# of the sidebar.
html_logo = '../images/about_brz_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '../images/brz.ico'
...
LATEX_PREAMBULE = ''
with open('./latex/preambule.tex', 'r+') as f:
    LATEX_PREAMBULE = f.read()
...
latex_elements = {
    ...
    'preamble': LATEX_PREAMBULE,

    # For \usepackage[russian]{babel}
    # 'babel': 'russian',
}
...
breathe_projects = { "beremiz_targets": "./doxygen/xml/" }
breathe_default_project = "beremiz_targets"
